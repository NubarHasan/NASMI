-- ============================================================
-- NASMI Database Schema (Full Version - Fixed)
-- ============================================================
...
-- ------------------------------------------------------------
-- 11. audit_log (تم التصحيح: performed_at أصبح timestamp)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 12. system_logs (تم التصحيح: created_at أصبح timestamp)
-- ------------------------------------------------------------
...
CREATE INDEX IF NOT EXISTS idx_systemlogs_timestamp ON system_logs(timestamp);
-- ------------------------------------------------------------
-- 13. exports
-- ------------------------------------------------------------
