...
class Job:
    ...
    _completed_at: str | None = field(default=None, repr=False, init=False)
    _cancelled_at: str | None = field(default=None, repr=False, init=False)
    ...
    def from_dict(cls, data: dict[str, Any]) -> Job:
        ...
        job._started_at = data.get("started_at")
        job._completed_at = data.get("completed_at")
        job._cancelled_at = data.get("cancelled_at")
